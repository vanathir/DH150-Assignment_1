...
1. *Visibility of system status*
    - Definition: system should provide users visual feedback on the site and within a reasonable amount of time; what is going on in the system
    - Ex. status bar, what page the user is on/ how many pages they have left (if survey), progressive bar, loading animation
    - The example shown below is a survey page that is found in the Contiki website. It is not a very good example of the visibility of the system status because it is small, and does not necessarily show the user how much of the survey is left. There is no way for the user to see how far along in the survey they are and how much is left because it is only long page. Since the system does not do a good job of keeping the user informed on what is going on in terms of the survey, it is a bad example of visibility of system status. Perhaps if the survey had a progressive bar that showed the user how much more there is left, then it would have been a good example. In addition. It is also hard to navigate because it is hidden  on the right side of the page. It seems bigger because I screenshotted it. 
    - Severity rating: 3
